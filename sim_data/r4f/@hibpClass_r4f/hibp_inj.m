...
%global poid_cyl da_cyl;% position data
%
NE=obj.NEt;
TE=obj.TEt;
PHI=obj.PHIt;
...
v=x;
for a=1:n1
%NE_local=probeEQ_local(obj,x0(1),x0(3),x0(2),obj.NE);
%TE_local=probeEQ_local(obj,x0(1),x0(3),x0(2),obj.TE);
[NE_local,TE_local]=probeEQ_local_para(obj,x0(1),x0(3),x0(2),NE,TE);
CAT=co_atten(obj, TE_local);
x1=Runge_motion(obj,x0,dt,cof1,cof2,PHI);
x(a)=x1(1)*cos(x1(2));
y(a)=x1(1)*sin(x1(2));
z(a)=x1(3);
...
[NE_local,TE_local]=probeEQ_local_para(obj,x0(1),x0(3),x0(2),NE,TE);
CAT=co_atten(obj,TE_local);
x1=Runge_motion(obj,x0,dt*dn,cof1,cof2,PHI);
...
v(a)=sqrt(x1(4)^2+(x1(5)*x1(1))^2+x1(6)^2);
x0=x1;
%NE1=probeEQ_local(obj,x0(1),x0(3),x0(2),obj.NE);
%TE1=probeEQ_local(obj,x0(1),x0(3),x0(2),obj.TE);
[NE1,TE1]=probeEQ_local_para(obj,x0(1),x0(3),x0(2),NE,TE);
CAT1=co_atten(obj, TE1);
x1=Runge_motion(obj,x0,dt*(1-dn),cof1,cof2,PHI);
...
%fprintf('%3e\t\n',2.0*CAT1(1)*NE1*dt1,exp(inten0),exp(inten1));
end