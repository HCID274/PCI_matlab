...
n2=n1+1;
p2=p1+1;
z=da_mag(3)*(da_mag(2)*(da_mag(1)*data2(m1,n1,p1,:)+(1.0-da_mag(1))*data2(m2,n1,p1,:)) ...
    + (1.0-da_mag(2))*(da_mag(1)*data2(m1,n2,p1,:)+(1-da_mag(1))*data2(m2,n2,p1,:))) ...
    + (1.0-da_mag(3))*(da_mag(2)*(da_mag(1)*data2(m1,n1,p2,:)+(1.0-da_mag(1))*data2(m2,n1,p2,:)) ...
    + (1.0-da_mag(2))*(da_mag(1)*data2(m1,n2,p2,:)+(1-da_mag(1))*data2(m2,n2,p2,:)));
z=pcs_1*z;
BR=z(1);
BZ=z(2);
BT=z(3);
