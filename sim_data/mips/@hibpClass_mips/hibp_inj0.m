function [x,y,z,v,bp,inten]=hibp_inj(obj,x0,out_pos,tracemax,ion_p)
...
v=x;
for a=1:n1
NE_local=probeEQ_local_s(obj,x0(1),x0(3),x0(2),obj.PLASMA_NE0+obj.PLASMA_NE);
TE_local=probeEQ_local_s(obj,x0(1),x0(3),x0(2),obj.PLASMA_TE0+obj.PLASMA_TE);
...
if(x1(1) > out_pos(1))
    [dt_b x1]=bdpoint(x0,x1,out_pos(1));
    bp=a
    x(a)=x1(1)*cos(x1(2));
    y(a)=x1(1)*sin(x1(2));
    z(a)=x1(3);
...
v(a)=sqrt(x1(4)^2+(x1(5)*x1(1))^2+x1(6)^2);
x0=x1;
NE1=probeEQ_local_s(obj,x0(1),x0(3),x0(2),obj.PLASMA_NE0+obj.PLASMA_NE)
TE1=probeEQ_local_s(obj,x0(1),x0(3),x0(2),obj.PLASMA_TE0+obj.PLASMA_TE)
