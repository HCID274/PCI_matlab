function plot_trace_rho1(sim,data_n,t,in_ang1)
oldpath=path;
path('../com',oldpath);
f_path='path.txt';
%
...
inten(s)=inten_out(s);
poten_local(s)=probeEQ_local_s(dataC,R0,Z0,PHI0,dataC.PLASMA_PHI_total);
...
pause
hold on
plot(rho,poten_local,'ro','Linewidth',2)
hold off
pause
plot(rho,inten_out,'ko','Linewidth',2)
set(gca,'FontSize',14);
set(gca,'FontName','Times');
xlabel('\rho','Fontsize',20);
...
plot(rho,ne_local,'ro','Linewidth',2)
hold off
%
path(oldpath)
end
